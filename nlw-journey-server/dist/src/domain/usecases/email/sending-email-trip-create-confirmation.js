...
exports.SendingEmailTripCreate = void 0;
...
var SendingEmailTripCreate = /** @class */ (function () {
    function SendingEmailTripCreate(emailService) {
        this.emailService = emailService;
        this.urlBuilder = (0, helpers_1.createFrontUrlBuilderDevelopment)();
    }
    SendingEmailTripCreate.prototype.send = function (trip) {
        return __awaiter(this, void 0, void 0, function () {
            var destination, startsAt, endsAt, email, formattedDates, htmlContent, sendEmailInfo, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        destination = trip.destination, startsAt = trip.startsAt, endsAt = trip.endsAt, email = trip.owner.email;
                        formattedDates = this.formatTripDates(startsAt, endsAt);
                        htmlContent = email_1.tripCreateConfirmationTemplateHtml
    ...
    SendingEmailTripCreate.prototype.formatTripDates = function (startsAt, endsAt) {
    ...
    return SendingEmailTripCreate;
}());
exports.SendingEmailTripCreate = SendingEmailTripCreate;
